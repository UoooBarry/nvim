...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    loaded = true,
    path = "/Users/barry/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  ["nvim-ufo"] = {
    loaded = true,
    path = "/Users/barry/.local/share/nvim/site/pack/packer/start/nvim-ufo",
